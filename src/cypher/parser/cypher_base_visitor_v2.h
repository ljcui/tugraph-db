...
#include "cypher/parser/generated/LcypherVisitor.h"
...
class VisitGuard {
 ...
 public:
  ...
  static bool InClause(VisitType type,
                       const std::unordered_set<VisitType> &cur_types) {
...
class CypherBaseVisitorV2 : public LcypherVisitor {
  ...
  static const std::unordered_map<std::string,
                                  geax::frontend::GeneralSetFunction>
      S_AGG_LIST;
  static const std::unordered_map<std::string,
                                  geax::frontend::BinarySetFunction>
      S_BAGG_LIST;
 ...
 public:
  ...
  std::any visitOC_MergeAction(
      LcypherParser::OC_MergeActionContext *ctx) override;
  ...
  std::any visitOC_RemoveItem(
      LcypherParser::OC_RemoveItemContext *ctx) override;

  std::any visitOC_InQueryCall(
      LcypherParser::OC_InQueryCallContext *ctx) override;

  std::any visitOC_StandaloneCall(
      LcypherParser::OC_StandaloneCallContext *ctx) override;

  std::any visitOC_YieldItems(
      LcypherParser::OC_YieldItemsContext *ctx) override;
  ...
  std::any visitOC_ReturnBody(
      LcypherParser::OC_ReturnBodyContext *ctx) override;

  std::any visitOC_ReturnItems(
      LcypherParser::OC_ReturnItemsContext *ctx) override;

  std::any visitOC_ReturnItem(
      LcypherParser::OC_ReturnItemContext *ctx) override;
  ...
  std::any visitOC_PatternPart(
      LcypherParser::OC_PatternPartContext *ctx) override;

  std::any visitOC_AnonymousPatternPart(
      LcypherParser::OC_AnonymousPatternPartContext *ctx) override;

  std::any visitOC_PatternElement(
      LcypherParser::OC_PatternElementContext *ctx) override;

  std::any visitOC_NodePattern(
      LcypherParser::OC_NodePatternContext *ctx) override;
  ...
  std::any visitOC_RelTypeName(
      LcypherParser::OC_RelTypeNameContext *ctx) override;

  std::any visitOC_Expression(
      LcypherParser::OC_ExpressionContext *ctx) override;

  std::any visitOC_OrExpression(
      LcypherParser::OC_OrExpressionContext *ctx) override;

  std::any visitOC_XorExpression(
      LcypherParser::OC_XorExpressionContext *ctx) override;

  std::any visitOC_AndExpression(
      LcypherParser::OC_AndExpressionContext *ctx) override;

  std::any visitOC_NotExpression(
  ...
  std::any visitOC_BooleanLiteral(
      LcypherParser::OC_BooleanLiteralContext *ctx) override;

  std::any visitOC_ListLiteral(
      LcypherParser::OC_ListLiteralContext *ctx) override;
  ...
  std::any visitOC_PropertyLookup(
      LcypherParser::OC_PropertyLookupContext *ctx) override;

  std::any visitOC_CaseExpression(
  ...
  std::any visitOC_NumberLiteral(
      LcypherParser::OC_NumberLiteralContext *ctx) override;

  std::any visitOC_MapLiteral(
      LcypherParser::OC_MapLiteralContext *ctx) override;
