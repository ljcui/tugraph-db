...
void checkedCast(Base *b, Drive *&d, const std::string &file, int line) {
  static_assert(std::is_base_of<Base, Drive>::value,
                "type `Base` must be the base of type `Drive`");
  d = dynamic_cast<Drive *>(b);
  if (!d) {
    THROW_CODE(Unimplemented, "Unimplemented operation, {}:{}", file, line);
  }
}

template <typename TargetType>
void checkedAnyCast(const std::any &s, TargetType *&d, const std::string &file,
                    int line) {
  try {
...
#define CastOrThrow(a, b) checkedCast(a, b, __FILE__, __LINE__)
#define AnyCastOrThrow(a, b) checkedAnyCast(a, b, __FILE__, __LINE__)
...
std::string CypherBaseVisitorV2::GetFullText(
    antlr4::ParserRuleContext *ruleCtx) const {
  if (ruleCtx->children.size() == 0) {
    return "";
  }
  auto *startToken = ruleCtx->getStart();
  auto *stopToken = ruleCtx->getStop();
  antlr4::misc::Interval interval(startToken->getStartIndex(),
...
std::any CypherBaseVisitorV2::visitOC_Cypher(
    LcypherParser::OC_CypherContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_Statement(
    LcypherParser::OC_StatementContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_Query(
    LcypherParser::OC_QueryContext *ctx) {
  return visitChildren(ctx);
...
std::any CypherBaseVisitorV2::visitOC_RegularQuery(
    LcypherParser::OC_RegularQueryContext *ctx) {
  geax::frontend::ProcedureBody *body = nullptr;
  CastOrThrow(node_, body);
...
std::any CypherBaseVisitorV2::visitOC_Union(
    LcypherParser::OC_UnionContext *ctx) {
  return visitChildren(ctx);
}

std::any CypherBaseVisitorV2::visitOC_SingleQuery(
    LcypherParser::OC_SingleQueryContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_SinglePartQuery(
  ...
  if (ctx->oC_UpdatingClause().empty()) {
    ...
    if (!VisitGuard::InClause(VisitType::kUnionClause, visit_types_)) {
      ...
      stmt->joinQuery()->head()->appendBody(
          ALLOC_GEAOBJECT(geax::frontend::Union), l);
    }
...
std::any CypherBaseVisitorV2::visitOC_MultiPartQuery(
    LcypherParser::OC_MultiPartQueryContext *ctx) {
  geax::frontend::ProcedureBody *body = nullptr;
  CastOrThrow(node_, body);
  ...
  for (auto child : ctx->children) {
    if (typeid(*child) ==
        typeid(parser::LcypherParser::OC_ReadingClauseContext)) {
      temp.push_back(child);
    } else if (typeid(*child) ==
               typeid(parser::LcypherParser::OC_UpdatingClauseContext)) {
      temp.push_back(child);
    } else if (typeid(*child) ==
               typeid(parser::LcypherParser::OC_WithContext)) {
      temp.push_back(child);
...
std::any CypherBaseVisitorV2::visitOC_UpdatingClause(
    LcypherParser::OC_UpdatingClauseContext *ctx) {
  return visitChildren(ctx);
}

std::any CypherBaseVisitorV2::visitOC_ReadingClause(
    LcypherParser::OC_ReadingClauseContext *ctx) {
  return visitChildren(ctx);
}

std::any CypherBaseVisitorV2::visitOC_Match(
    LcypherParser::OC_MatchContext *ctx) {
  if (VisitGuard::InClause(VisitType::kReadingClause, visit_types_)) {
    ...
    if (ctx->OPTIONAL_())
      match->setStatementMode(geax::frontend::StatementMode::kOptional);
...
std::any CypherBaseVisitorV2::visitOC_Unwind(
    LcypherParser::OC_UnwindContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_Merge(
    LcypherParser::OC_MergeContext *ctx) {
  geax::frontend::LinearDataModifyingStatement *node = nullptr;
  CastOrThrow(node_, node);
...
std::any CypherBaseVisitorV2::visitOC_MergeAction(
    LcypherParser::OC_MergeActionContext *ctx) {
  if (ctx->MATCH()) {
...
std::any CypherBaseVisitorV2::visitOC_Create(
    LcypherParser::OC_CreateContext *ctx) {
  if (VisitGuard::InClause(VisitType::kReadingClause, visit_types_)) {
    NOT_SUPPORT_AND_THROW();
  } else if (VisitGuard::InClause(VisitType::kUpdatingClause, visit_types_)) {
    geax::frontend::LinearDataModifyingStatement *node = nullptr;
...
std::any CypherBaseVisitorV2::visitOC_SetItem(
    LcypherParser::OC_SetItemContext *ctx) {
  ...
  if (ctx->oC_PropertyExpression()) {
    ...
    // so ugly！！！
    auto **src = const_cast<geax::frontend::Expr **>(&(std::get<1>(prop[0])));
    *src = expr;
  } else {
    geax::frontend::Expr *name_expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Variable()), name_expr);
    ...
    if (ctx->oC_Expression()) {
      ...
      AnyCastOrThrow(visit(ctx->oC_NodeLabels()), labels);
      if (labels.empty()) {
        NOT_SUPPORT_AND_THROW();
      }
...
std::any CypherBaseVisitorV2::visitOC_Delete(
    LcypherParser::OC_DeleteContext *ctx) {
  if (VisitGuard::InClause(VisitType::kReadingClause, visit_types_)) {
    NOT_SUPPORT_AND_THROW();
  } else if (VisitGuard::InClause(VisitType::kUpdatingClause, visit_types_)) {
    geax::frontend::LinearDataModifyingStatement *node = nullptr;
    ...
    for (auto e : ctx->oC_Expression()) {
      ...
      geax::frontend::Expr *expr = nullptr;
      AnyCastOrThrow(visit(e), expr);
      if (expr->type() != geax::frontend::AstNodeType::kRef) {
        THROW_CODE(InputError,
                   "Type mismatch: expected Node, Path or Relationship");
      }
...
std::any CypherBaseVisitorV2::visitOC_Remove(
    LcypherParser::OC_RemoveContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_RemoveItem(
    LcypherParser::OC_RemoveItemContext *ctx) {
  ...
  if (ctx->oC_PropertyExpression()) {
    ...
    AnyCastOrThrow(visit(ctx->oC_PropertyExpression()->oC_Atom()), name_expr);
    if (pe_ctx->oC_PropertyLookup().empty()) CYPHER_TODO();
    AnyCastOrThrow(visit(pe_ctx->oC_PropertyLookup(0)), property_expr);
    geax::frontend::Ref *vstr = nullptr;
    geax::frontend::VString *pstr = nullptr;
    CastOrThrow(name_expr, vstr);
    CastOrThrow(property_expr, pstr);
...
std::any CypherBaseVisitorV2::visitOC_InQueryCall(
    LcypherParser::OC_InQueryCallContext *ctx) {
  geax::frontend::AmbientLinearQueryStatement *node = nullptr;
  CastOrThrow(node_, node);
...
std::any CypherBaseVisitorV2::visitOC_StandaloneCall(
    LcypherParser::OC_StandaloneCallContext *ctx) {
  geax::frontend::ProcedureBody *body = nullptr;
  CastOrThrow(node_, body);
  auto node = ALLOC_GEAOBJECT(geax::frontend::StatementWithYield);
  body->appendStatement(node);
  ...
  if (ctx->oC_ExplicitProcedureInvocation()) {
    SWITCH_CONTEXT_VISIT(ctx->oC_ExplicitProcedureInvocation(),
                         named_procedure);
  } else if (ctx->oC_ImplicitProcedureInvocation()) {
    SWITCH_CONTEXT_VISIT(ctx->oC_ImplicitProcedureInvocation(),
                         named_procedure);
  }
  if (ctx->oC_YieldItems()) {
    auto yield_fields = ALLOC_GEAOBJECT(geax::frontend::YieldField);
...
std::any CypherBaseVisitorV2::visitOC_YieldItems(
    LcypherParser::OC_YieldItemsContext *ctx) {
  if (ctx->oC_Where()) {
    visit(ctx->oC_Where());
  }
...
std::any CypherBaseVisitorV2::visitOC_YieldItem(
    LcypherParser::OC_YieldItemContext *ctx) {
  if (ctx->AS()) NOT_SUPPORT_AND_THROW();
  geax::frontend::YieldField *yield_fields = nullptr;
  CastOrThrow(node_, yield_fields);
  yield_fields->appendItem(ctx->oC_Variable()->getText(),
...
std::any CypherBaseVisitorV2::visitOC_Return(
    LcypherParser::OC_ReturnContext *ctx) {
  if (VisitGuard::InClause(VisitType::kReadingClause, visit_types_)) {
    geax::frontend::AmbientLinearQueryStatement *node = nullptr;
    CastOrThrow(node_, node);
    auto result = ALLOC_GEAOBJECT(geax::frontend::PrimitiveResultStatement);
...
std::any CypherBaseVisitorV2::visitOC_ReturnBody(
    LcypherParser::OC_ReturnBodyContext *ctx) {
  ...
  if (ctx->oC_Order()) {
    ...
    for (auto order_by_field : node->orderBys()) {
      ...
      if (!found) {
        return_items.emplace_back(field_name_str, order_by_field->field(),
                                  true);
      }
    }
...
std::any CypherBaseVisitorV2::visitOC_ReturnItems(
    LcypherParser::OC_ReturnItemsContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_ReturnItem(
    LcypherParser::OC_ReturnItemContext *ctx) {
  geax::frontend::PrimitiveResultStatement *node = nullptr;
  CastOrThrow(node_, node);
  geax::frontend::Expr *expr = nullptr;
  AnyCastOrThrow(visit(ctx->oC_Expression()), expr);
  ...
  if (ctx->oC_Variable()) {
    ...
    if (VisitGuard::InClause(VisitType::kWithClause, visit_types_)) {
      ...
      AnyCastOrThrow(visit(ctx->oC_Expression()), with_expr);
      if (with_expr->type() != geax::frontend::AstNodeType::kRef) {
        THROW_CODE(ParserException,
                   "Non-variable expression in WITH must be aliased");
      }
    }
...
std::any CypherBaseVisitorV2::visitOC_Order(
    LcypherParser::OC_OrderContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_Skip(LcypherParser::OC_SkipContext *ctx) {
  ...
  CastOrThrow(expr, integer);
  node->setOffset(integer->val());
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_Limit(
    LcypherParser::OC_LimitContext *ctx) {
  geax::frontend::PrimitiveResultStatement *node = nullptr;
  CastOrThrow(node_, node);
  geax::frontend::Expr *expr = nullptr;
  AnyCastOrThrow(visit(ctx->oC_Expression()), expr);
...
std::any CypherBaseVisitorV2::visitOC_SortItem(
    LcypherParser::OC_SortItemContext *ctx) {
  geax::frontend::PrimitiveResultStatement *node = nullptr;
  CastOrThrow(node_, node);
...
std::any CypherBaseVisitorV2::visitOC_Hint(LcypherParser::OC_HintContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_Where(
    LcypherParser::OC_WhereContext *ctx) {
  if (VisitGuard::InClause(VisitType::kWithClause, visit_types_)) {
    if (VisitGuard::InClause(VisitType::kReadingClause, visit_types_) ||
        VisitGuard::InClause(VisitType::kUpdatingClause, visit_types_)) {
      filter_in_with_clause_ = ALLOC_GEAOBJECT(geax::frontend::FilterStatement);
      geax::frontend::Expr *where = nullptr;
      AnyCastOrThrow(visit(ctx->oC_Expression()), where);
...
std::any CypherBaseVisitorV2::visitOC_Pattern(
    LcypherParser::OC_PatternContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_PatternPart(
    LcypherParser::OC_PatternPartContext *ctx) {
  if (VisitGuard::InClause(VisitType::kReadingPattern, visit_types_) ||
...
std::any CypherBaseVisitorV2::visitOC_PatternElement(
    LcypherParser::OC_PatternElementContext *ctx) {
  if (ctx->oC_NodePattern() == nullptr) NOT_SUPPORT_AND_THROW();
  geax::frontend::PathChain *pathChain = nullptr;
  CastOrThrow(node_, pathChain);
...
std::any CypherBaseVisitorV2::visitOC_NodePattern(
    LcypherParser::OC_NodePatternContext *ctx) {
  VisitGuard guard(VisitType::kNodePattern, visit_types_);
...
std::any CypherBaseVisitorV2::visitOC_RelationshipPattern(
  ...
  VisitGuard guard(VisitType::kRelationshipPattern, visit_types_);
  geax::frontend::Edge *edge = nullptr;
  CastOrThrow(node_, edge);
  geax::frontend::EdgeDirection direction;
  if (ctx->oC_LeftArrowHead() != nullptr &&
      ctx->oC_RightArrowHead() == nullptr) {
    direction = geax::frontend::EdgeDirection::kPointLeft;
  } else if (ctx->oC_RightArrowHead() != nullptr &&
             ctx->oC_LeftArrowHead() == nullptr) {
...
std::any CypherBaseVisitorV2::visitOC_Properties(
    LcypherParser::OC_PropertiesContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_RelationshipTypes(
  ...
  for (auto &ctx_label : ctx->oC_RelTypeName()) {
    geax::frontend::Expr *name_expr = nullptr;
    AnyCastOrThrow(visit(ctx_label), name_expr);
    geax::frontend::VString *vstr = nullptr;
    CastOrThrow(name_expr, vstr);
    std::string name = vstr->val();
    label_strs.emplace_back(name);
  }
  if (VisitGuard::InClause(VisitType::kUpdatingPattern, visit_types_)) {
    if (label_strs.size() != 1) {
      THROW_CODE(CypherException,
                 "Create a relationship with more than one type");
    }
  }
  if (label_strs.size() == 1) {
    auto l = ALLOC_GEAOBJECT(geax::frontend::SingleLabel);
...
std::any CypherBaseVisitorV2::visitOC_NodeLabels(
    LcypherParser::OC_NodeLabelsContext *ctx) {
  std::vector<std::string> label_strs;
...
std::any CypherBaseVisitorV2::visitOC_NodeLabel(
    LcypherParser::OC_NodeLabelContext *ctx) {
  return visit(ctx->oC_LabelName());
}

std::any CypherBaseVisitorV2::visitOC_RangeLiteral(
    LcypherParser::OC_RangeLiteralContext *ctx) {
  geax::frontend::Edge *edge = nullptr;
  CastOrThrow(node_, edge);
  int low = 0, hight = 0;
...
std::any CypherBaseVisitorV2::visitOC_LabelName(
    LcypherParser::OC_LabelNameContext *ctx) {
  return visit(ctx->oC_SchemaName());
}

std::any CypherBaseVisitorV2::visitOC_RelTypeName(
    LcypherParser::OC_RelTypeNameContext *ctx) {
  return visit(ctx->oC_SchemaName());
}

std::any CypherBaseVisitorV2::visitOC_Expression(
    LcypherParser::OC_ExpressionContext *ctx) {
  return ctx->oC_OrExpression()->accept(this);
}

std::any CypherBaseVisitorV2::visitOC_OrExpression(
    LcypherParser::OC_OrExpressionContext *ctx) {
  geax::frontend::Expr *left = nullptr, *right = nullptr;
  for (size_t idx = 0; idx < ctx->oC_XorExpression().size(); ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_XorExpression(idx)), right);
    if (idx > 0) {
...
std::any CypherBaseVisitorV2::visitOC_XorExpression(
    LcypherParser::OC_XorExpressionContext *ctx) {
  geax::frontend::Expr *left = nullptr, *right = nullptr;
  for (size_t idx = 0; idx < ctx->oC_AndExpression().size(); ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_AndExpression(idx)), right);
    if (idx > 0) {
...
std::any CypherBaseVisitorV2::visitOC_AndExpression(
    LcypherParser::OC_AndExpressionContext *ctx) {
  geax::frontend::Expr *left = nullptr, *right = nullptr;
  for (size_t idx = 0; idx < ctx->oC_NotExpression().size(); ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_NotExpression(idx)), right);
    if (idx > 0) {
...
std::any CypherBaseVisitorV2::visitOC_NotExpression(
    LcypherParser::OC_NotExpressionContext *ctx) {
  if (ctx->NOT().size() % 2) {
    auto op = ALLOC_GEAOBJECT(geax::frontend::Not);
    geax::frontend::Expr *expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_ComparisonExpression()), expr);
    op->setExpr(expr);
...
std::any CypherBaseVisitorV2::visitOC_ComparisonExpression(
  ...
  geax::frontend::Expr *expr = nullptr;
  AnyCastOrThrow(visit(ctx->oC_AddOrSubtractExpression()), expr);
  ...
  AnyCastOrThrow(visit(ctx->oC_PartialComparisonExpression(0)), bi);
  bi->setLeft(expr);
...
std::any CypherBaseVisitorV2::visitOC_AddOrSubtractExpression(
  ...
  geax::frontend::Expr *left = nullptr, *right = nullptr;
  for (size_t idx = 0; idx < ctx->oC_MultiplyDivideModuloExpression().size();
       ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_MultiplyDivideModuloExpression(idx)), right);
    if (idx > 0) {
...
std::any CypherBaseVisitorV2::visitOC_MultiplyDivideModuloExpression(
  ...
  for (size_t idx = 0; idx < ctx->oC_PowerOfExpression().size(); ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_PowerOfExpression(idx)), right);
    if (idx > 0) {
      geax::frontend::BinaryOp *op = nullptr;
      if (ops[idx - 1] == "*") {
...
std::any CypherBaseVisitorV2::visitOC_PowerOfExpression(
  ...
  geax::frontend::Expr *left = nullptr, *right = nullptr;
  for (size_t idx = 0; idx < ctx->oC_UnaryAddOrSubtractExpression().size();
       ++idx) {
    left = right;
    AnyCastOrThrow(visit(ctx->oC_UnaryAddOrSubtractExpression(idx)), right);
    if (idx > 0) {
      geax::frontend::BinaryOp *op = nullptr;
      if (ops[idx - 1] == "^") {
...
std::any CypherBaseVisitorV2::visitOC_UnaryAddOrSubtractExpression(
  ...
  geax::frontend::Expr *expr = nullptr;
  AnyCastOrThrow(visit(ctx->oC_StringListNullOperatorExpression()), expr);
  if (sign) {
...
std::any CypherBaseVisitorV2::visitOC_StringListNullOperatorExpression(
  ...
  geax::frontend::Expr *expr = nullptr;
  AnyCastOrThrow(visit(ctx->oC_PropertyOrLabelsExpression()), expr);
  if (!ctx->oC_NullOperatorExpression().empty()) {
    ...
    for (auto e : ctx->oC_StringOperatorExpression()) {
      ...
      AnyCastOrThrow(visit(e), func_expr);
      geax::frontend::Function *func = nullptr;
      CastOrThrow(func_expr, func);
      func->appendArg(expr);
    ...
    if (list_op_expr->IN()) {
      ...
      AnyCastOrThrow(visit(list_op_expr->oC_PropertyOrLabelsExpression()),
                     right);
      ...
      for (size_t idx = 0; idx < list_op_expr->oC_Expression().size(); ++idx) {
        geax::frontend::Expr *expr = nullptr;
        AnyCastOrThrow(visit(list_op_expr->oC_Expression(idx)), expr);
        func->appendArg(expr);
      }
      return (geax::frontend::Expr *)func;
    }
...
std::any CypherBaseVisitorV2::visitOC_PropertyOrLabelsExpression(
  ...
  if (!ctx->oC_PropertyLookup().empty()) {
    ...
    geax::frontend::Expr *name_expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_PropertyLookup(0)), name_expr);
    geax::frontend::VString *vstr = nullptr;
    CastOrThrow(name_expr, vstr);
    std::string field_name = vstr->val();
    field->setFieldName(std::move(field_name));
    geax::frontend::Expr *expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Atom()), expr);
    field->setExpr(expr);
...
std::any CypherBaseVisitorV2::visitOC_Atom(LcypherParser::OC_AtomContext *ctx) {
  if (ctx->oC_Variable()) {
    ...
    if (list_comprehension_anonymous_symbols_.depth_ != 0 &&
        list_comprehension_anonymous_symbols_.name_.find(name) !=
            list_comprehension_anonymous_symbols_.name_.end()) {
      auto list_comprehension_name =
          list_comprehension_anonymous_symbols_.name_[name].top();
      expr->setName(std::move(list_comprehension_name));
    } else if (predicate_function_anonymous_symbols_.depth_ != 0 &&
               predicate_function_anonymous_symbols_.name_.find(name) !=
                   predicate_function_anonymous_symbols_.name_.end()) {
      auto predicate_function_name =
          predicate_function_anonymous_symbols_.name_[name].top();
    ...
    predicate_function_anonymous_symbols_.depth_--;
    predicate_function_anonymous_symbols_
        .name_[ctx->oC_FilterExpression()
                   ->oC_IdInColl()
                   ->oC_Variable()
                   ->getText()]
        .pop();
...
std::any CypherBaseVisitorV2::visitOC_Literal(
    LcypherParser::OC_LiteralContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_BooleanLiteral(
    LcypherParser::OC_BooleanLiteralContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_ListLiteral(
    LcypherParser::OC_ListLiteralContext *ctx) {
  auto list = ALLOC_GEAOBJECT(geax::frontend::MkList);
  for (auto &ctx_expr : ctx->oC_Expression()) {
    geax::frontend::Expr *expr = nullptr;
    AnyCastOrThrow(visit(ctx_expr), expr);
...
std::any CypherBaseVisitorV2::visitOC_IdInColl(
    LcypherParser::OC_IdInCollContext *ctx) {
  if (VisitGuard::InClause(VisitType::kPredicateFunction, visit_types_)) {
    ...
    if (predicate_function_anonymous_symbols_.name_.find(var) ==
        predicate_function_anonymous_symbols_.name_.end()) {
      predicate_function_anonymous_symbols_.name_[var] =
    ...
    if (list_comprehension_anonymous_symbols_.name_.find(var) ==
        list_comprehension_anonymous_symbols_.name_.end()) {
      list_comprehension_anonymous_symbols_.name_[var] =
          std::stack<std::string>();
    }
...
std::any CypherBaseVisitorV2::visitOC_FunctionInvocation(
  ...
  std::string name;
  AnyCastOrThrow(visit(ctx->oC_FunctionName()), name);
  ...
  if (name == "EXISTS") {
    ...
    geax::frontend::Expr *expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Expression(0)), expr);
    ...
    geax::frontend::Expr *left = nullptr, *right = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Expression(0)), left);
    AnyCastOrThrow(visit(ctx->oC_Expression(1)), right);
    ...
    for (size_t idx = 0; idx < ctx->oC_Expression().size(); ++idx) {
      geax::frontend::Expr *expr = nullptr;
      AnyCastOrThrow(visit(ctx->oC_Expression(idx)), expr);
      func->appendArg(expr);
    }
    res = func;
  }
...
std::any CypherBaseVisitorV2::visitOC_FunctionName(
    LcypherParser::OC_FunctionNameContext *ctx) {
  if (ctx->EXISTS()) {
    return std::string("EXISTS");
  }
  std::string name;
  if (ctx->oC_Namespace()) {
    AnyCastOrThrow(visit(ctx->oC_Namespace()), name);
  }
...
std::any CypherBaseVisitorV2::visitOC_ProcedureResultField(
    LcypherParser::OC_ProcedureResultFieldContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_ProcedureName(
    LcypherParser::OC_ProcedureNameContext *ctx) {
  std::string name;
  if (ctx->oC_Namespace()) {
    AnyCastOrThrow(visit(ctx->oC_Namespace()), name);
  }
...
std::any CypherBaseVisitorV2::visitOC_Namespace(
    LcypherParser::OC_NamespaceContext *ctx) {
  std::string name_space;
  for (auto &s : ctx->oC_SymbolicName())
    name_space.append(s->getText()).append(".");
  return name_space;
}
...
std::any CypherBaseVisitorV2::visitOC_ListComprehension(
  ...
  if (ctx->oC_Expression()) {
    AnyCastOrThrow(visit(ctx->oC_Expression()), op_expr);
  } else {
    CYPHER_TODO();
  }
...
std::any CypherBaseVisitorV2::visitOC_PatternComprehension(
    LcypherParser::OC_PatternComprehensionContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_PropertyLookup(
    LcypherParser::OC_PropertyLookupContext *ctx) {
  return visit(ctx->oC_PropertyKeyName());
}

std::any CypherBaseVisitorV2::visitOC_CaseExpression(
    LcypherParser::OC_CaseExpressionContext *ctx) {
  ...
  if (ctx->oC_Expression().empty()) {
    ...
    AnyCastOrThrow(visit(ctx->oC_Expression()[0]), head);
    case_clause->setInput(head);
    geax::frontend::Expr *tail = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Expression()[1]), tail);
...
std::any CypherBaseVisitorV2::visitOC_Variable(
    LcypherParser::OC_VariableContext *ctx) {
  return visit(ctx->oC_SymbolicName());
}

std::any CypherBaseVisitorV2::visitOC_NumberLiteral(
    LcypherParser::OC_NumberLiteralContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_MapLiteral(
    LcypherParser::OC_MapLiteralContext *ctx) {
  geax::frontend::Expr *res = nullptr;
  ...
  if (!VisitGuard::InClause(VisitType::kFunctionInvocation, visit_types_) &&
    ...
    for (size_t idx = 0; idx < ctx->oC_PropertyKeyName().size(); ++idx) {
      ...
      AnyCastOrThrow(visit(ctx->oC_Expression(idx)), expr);
      geax::frontend::Expr *name_expr = nullptr;
      AnyCastOrThrow(visit(ctx->oC_PropertyKeyName(idx)), name_expr);
      geax::frontend::VString *vstr = nullptr;
      CastOrThrow(name_expr, vstr);
      std::string name = vstr->val();
      ps->appendProperty(std::move(name), expr);
...
std::any CypherBaseVisitorV2::visitOC_PropertyExpression(
  ...
  if (VisitGuard::InClause(VisitType::kSetVariable, visit_types_)) {
    ...
    CastOrThrow(node_, node);
    geax::frontend::Expr *name_expr = nullptr;
    AnyCastOrThrow(visit(ctx->oC_Atom()), name_expr);
    geax::frontend::Ref *ref = nullptr;
    CastOrThrow(name_expr, ref);
    ...
    AnyCastOrThrow(visit(ctx->oC_PropertyLookup(0)), prop);
    geax::frontend::VString *prop_str = nullptr;
    CastOrThrow(prop, prop_str);
...
std::any CypherBaseVisitorV2::visitOC_IntegerLiteral(
    LcypherParser::OC_IntegerLiteralContext *ctx) {
  auto integer = ALLOC_GEAOBJECT(geax::frontend::VInt);
  integer->setVal(std::stol(ctx->getText()));
  return (geax::frontend::Expr *)integer;
}

std::any CypherBaseVisitorV2::visitOC_DoubleLiteral(
    LcypherParser::OC_DoubleLiteralContext *ctx) {
  auto d = ALLOC_GEAOBJECT(geax::frontend::VDouble);
  d->setVal(std::stod(ctx->getText()));
  return (geax::frontend::Expr *)d;
}

std::any CypherBaseVisitorV2::visitOC_SchemaName(
    LcypherParser::OC_SchemaNameContext *ctx) {
...
std::any CypherBaseVisitorV2::visitOC_ReservedWord(
    LcypherParser::OC_ReservedWordContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_SymbolicName(
    LcypherParser::OC_SymbolicNameContext *ctx) {
  auto s = ALLOC_GEAOBJECT(geax::frontend::VString);
  s->setVal(ctx->getText());
  return (geax::frontend::Expr *)s;
}

std::any CypherBaseVisitorV2::visitOC_LeftArrowHead(
    LcypherParser::OC_LeftArrowHeadContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_RightArrowHead(
    LcypherParser::OC_RightArrowHeadContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}

std::any CypherBaseVisitorV2::visitOC_Dash(LcypherParser::OC_DashContext *) {
  NOT_SUPPORT_AND_THROW();
  return 0;
}
