...
enum class ProcedureResultType : char { Value = 0, Node, Relationship };
...
struct ProcedureResult {
  ...
  Value AsValue() {
    if (type != ProcedureResultType::Value)
      THROW_CODE(UnknownError, "AsValue, but data is not Value");
    return std::any_cast<const Value &>(data);
  }
  graphdb::Vertex AsNode() {
    if (type != ProcedureResultType::Node)
      THROW_CODE(UnknownError, "AsNode, but data is not Node");
...
class AlgoFunc {
 public:
  static void PageRank(RTContext *ctx, const Record *record,
...
class LogFunc {
 public:
  static void QueryLog(RTContext *ctx, const Record *record,
                       const VEC_EXPR &args, const VEC_STR &yield_items,
                       std::vector<std::vector<ProcedureResult>> *records);
  static void SetLevel(RTContext *ctx, const Record *record,
                       const VEC_EXPR &args, const VEC_STR &yield_items,
                       std::vector<std::vector<ProcedureResult>> *records);
};
...
class BuiltinProcedure {
 public:
  static void DbmsProcedures(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbLabels(RTContext *ctx, const Record *record,
                       const VEC_EXPR &args, const VEC_STR &yield_items,
                       std::vector<std::vector<ProcedureResult>> *records);
  static void DbRelationshipTypes(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  ...
  static void DbIndexFullTextCreateNodeIndex(
      ...
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexFullTextQueryNodes(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexFullTextDeleteIndex(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexFullTextApplyWal(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexVectorCreateNodeIndex(
      ...
      const cypher::VEC_EXPR &args, const cypher::VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexVectorCreateNodeField(
      cypher::RTContext *ctx, const cypher::Record *record,
      const cypher::VEC_EXPR &args, const cypher::VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexVectorKnnSearchNodes(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexVectorApplyWal(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbIndexVectorDeleteIndex(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbmsGraphCreateGraph(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbmsGraphCreateGraphWithRaft(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbmsGraphDeleteGraph(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
  static void DbmsGraphListGraph(
      RTContext *ctx, const Record *record, const VEC_EXPR &args,
      const VEC_STR &yield_items,
      std::vector<std::vector<ProcedureResult>> *records);
...
typedef std::function<void(RTContext *, const Record *, const VEC_EXPR &,
                           const VEC_STR &,
                           std::vector<std::vector<ProcedureResult>> *records)>
    SA_FUNC;
...
struct Procedure {
  /* <name, <index, type>> */
  typedef std::vector<
      std::pair<std::string, std::pair<int, ProcedureResultType>>>
      SIG_SPEC;
  ...
  Procedure(std::string name, FUNC func, const SIG_SPEC &args,
            const SIG_SPEC &results)
